...
### Telegram 群组
* telegram 交流群:https://t.me/v2raySs_jz
...
```
wget -N --no-check-certificate -q -O install.sh "https://github.com/feikai2012/v2ws-tls_bash_onekey/raw/main/install.sh" && chmod +x install.sh && bash install.sh
```
...
* 目前支持Debian 9+ / Ubuntu 18.04+ / Centos7+ / Oravle VPS 8.6+，部分Centos模板可能存在难以处理的编译问题，建议遇到编译问题时，请更换至其他系统模板
...
帮助申请免费vps以及部署一步到位邮箱hubdev68@gmail.com
...
http://cp.u9un.com/aff.php?aff=3329
